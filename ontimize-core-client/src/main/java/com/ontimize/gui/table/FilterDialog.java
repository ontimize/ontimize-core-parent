...
public class FilterDialog extends EJDialog implements Internationalization, ActionListener {
	...
	protected Map<Object, Object>	filters							= null;
	...
	protected class FilterList extends JList {
		...
		public void setFilters(Map<Object, Object> filters, String col) {
			FilterModel model = new FilterModel(filters, col);
			this.setModel(model);
		}

		public boolean hasFilter(String col) {
			Map<Object, Object> h = this.getFilters();
			if (h == null) {
				return false;
			}
		...
		protected class FilterModel extends javax.swing.AbstractListModel {
			...
			private Map<Object, Object>	filters		= null;
			...
			public FilterModel(Map<Object, Object> filter, String column) {
				this.filters = filter;
				this.column = column;
	...
	protected JPanel getColumnListPanel() {
		...
		List<String> vColumns = this.table.getOriginallyVisibleColumns();
		List<FilterDialog.TranslatedItem> cT = new ArrayList<>();
		...
		Collections.sort(cT);
		if (vColumns != null) {
			this.columnsList.setListData(cT.toArray());
		}
		if (this.bundle != null) {
	...
	protected JPanel getSelectionFilterPanel() {
		...
		Map<Object, Object> hIntegerParam = new HashMap<>();
	...
	public void actionPerformed(ActionEvent e) {
		if ("ok".equalsIgnoreCase(e.getActionCommand())) {
			...
			Map<Object, Object> hFilter = new HashMap<>(this.filterList.getFilters());
	...
	protected String getFilterInfo() {
		Map<Object, Object> hFilters = ((FilterModel) this.filterList.getModel()).getFilters();
		if (hFilters.isEmpty()) {
			return "";
		}
	...
	public void show(MouseEvent e) {
		...
		String col = this.table.getJTable().getModel().getColumnName(this.column);
		if (col == null) {
			return;
		}
		...
		this.columnsList.setSelectedValue(new TranslatedItem(col), true);

		this.filters = this.sorter.getFilters();
		this.filterList.setFilters(new HashMap<>(this.filters), col);
