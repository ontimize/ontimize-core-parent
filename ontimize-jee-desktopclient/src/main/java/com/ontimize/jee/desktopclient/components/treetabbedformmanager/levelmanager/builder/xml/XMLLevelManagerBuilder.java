...
public class XMLLevelManagerBuilder extends XMLInterpreter implements com.ontimize.jee.desktopclient.components.treetabbedformmanager.levelmanager.builder.LevelManagerBuilder {
	...
	public XMLLevelManagerBuilder(Map<Object, Object> labelEquivalences) throws Exception {
		this.equivalenceLabelList = (Map<Object, Object>) ((HashMap<Object, Object>) labelEquivalences).clone();
		this.equivalenceLabelList.put("Node", DefaultLevel.class.getCanonicalName());
	}

	public XMLLevelManagerBuilder(Map<Object, Object> labelEquivalences, String guiClassesPackage) throws Exception {
	...
	protected void processChildren(List<CustomNode> childNodes, LevelManager guiNode, ResourceBundle resourceBundle) {
		...
		for (CustomNodeWrapper cnw : preProcessedNodes) {
			...
			if (customNode.isTag()) {
				...
				Map<Object, Object> attributeTable = new HashMap<>(cnw.getAttributes());
				...
				try {
					...
					try {
						...
						XMLLevelManagerBuilder.logger.error("Error creating object", exc2);
					}
				} catch (Exception exc) {
					XMLLevelManagerBuilder.logger.error("Error loading class ", exc);
				}
			}
	...
	private void fixAttributesIfNecessary(Map<Object, Object> attributeTable) {
